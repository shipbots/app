      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-sm mx-4 flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            <h1 className="text-xl font-bold text-gray-900">ShipBots Dashboard</h1>
            <p className="text-sm text-gray-400 mt-0.5">Internal operations platform</p>
          </div>
        </div>
        ...
        <p className="text-[11px] text-gray-400 text-center">
          Access restricted to authorized ShipBots team members.
        </p>
      </div>
    </div>
  );
